...
import './NavbarProviderDashboard.css';
import ThreeDotMenu from "../components/ThreeDotMenu";   // ✅ Correct import
// import UpcomingBookings from "./pages/UpcomingBookings"; // 👈 import your page


const NavbarProviderDashboard = ({ role }) => {
    ...
    <>
      ...
      <li className="nav-item">
        {/* <Link className="nav-link" to="/user/bookings">My Booking</Link> */}
         <Link className="nav-link" to="/user/upcoming-bookings">My Bookings</Link>
      </li>
    </>
  );
...
export default NavbarProviderDashboard;
