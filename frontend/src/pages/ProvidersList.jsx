          ...
          {loading ? (
            ...
            providers.map((provider) => (
              ...
              >
                <div className="provider-card card shadow-sm h-100">
                  <img
                    src={provider.image || "https://www.sprintdiagnostics.in/images/user.jpg"}
                    alt="Provider"
                    className="provider-img"
                  />
                  <div className="p-3">
                    ...
                    <div className="provider-info">
                      <p><span>Service:</span> {provider.category}</p>
                      <p><span>Location:</span> {provider.formattedAddress || "Unknown"}</p>
                      {provider.distance && (
                        <p>
                          <span>Distance:</span> {(provider.distance / 1000).toFixed(2)} km away
                        </p>
                      )}
                      <p>
                        <span>Availability:</span>{" "}
