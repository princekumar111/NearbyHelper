...
//           <h2 className="fw-bold text-primary">Admin Dashboard Overview</h2>
//         </div>
...
// // Placeholder components for demo - replace with your actual components or content
// const UsersList = () => (
//   <div>
//     <p>This is where you render the list of users.</p>
...
// const ProvidersList = () => (
//   <div>
//     <p>This is where you render the list of service providers.</p>
//     {/* Fetch and display providers here */}
//   </div>
// );

// const BookingsList = () => (
//   <div>
//     <p>This is where you render the list of bookings.</p>
//     {/* Fetch and display bookings here */}
//   </div>
// );
...
//                 onKeyPress={(e) => {
//                   if (e.key === 'Enter') setActiveView('users');
//                 }}
...
//                 onKeyPress={(e) => {
//                   if (e.key === 'Enter') setActiveView('providers');
//                 }}
//                 style={{ cursor: 'pointer' }}
//               >
//                 <div className="card-body d-flex flex-column align-items-center">
...
//                 onKeyPress={(e) => {
//                   if (e.key === 'Enter') setActiveView('bookings');
//                 }}
//                 style={{ cursor: 'pointer' }}
//               >
//                 <div className="card-body d-flex flex-column align-items-center">
...
//             {activeView === 'providers' && <ProvidersList />}
